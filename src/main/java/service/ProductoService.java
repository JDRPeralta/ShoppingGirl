...
public class ProductoService {
    ...
    public int registrar(ProductoModel p) {
    ...
    public int actualizar(ProductoModel p) {
    ...
    public List<ProductoModel> consultar(String texto) {
        List<ProductoModel> lista = new ArrayList<>();
    ...
    public List<ProductoModel> reporteStockBajo(int limite) {
        List<ProductoModel> lista = new ArrayList<>();
