...
public class VentaService {
    ...
    public int registrarVenta(VentaModel venta) {
        ...
        try {
            ...
            for (DetalleVentaModel d : venta.getDetalles()) {
    ...
    public List<VentaModel> consultarVentas(String fechaInicio, String fechaFin, String cliente) {
    ...
    public List<VentaModel> reporteVentasMensuales() {
        List<VentaModel> lista = new ArrayList<>();
