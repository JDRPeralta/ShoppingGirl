...
<head>
<meta charset="UTF-8">
<title>Proveedores - Shopping Girl</title>
...
<body>
    ...
    <div class="container">
        <div class="topbar">
            ...
            <p>Módulo de mantenimiento de proveedores</p>
        </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="proveedor-nombre"><%= p.getNombre() %></span></td>
                            <td><%= p.getTelefono() != null ? p.getTelefono() : "" %></td>
                            <td><%= p.getPais() != null ? p.getPais() : "" %></td>
                            <td>
                                <div class="acciones">
                                    <a href="<%= request.getContextPath() %>/ProveedorController?accion=editar&id=<%= p.getIdProveedor() %>" class="btn-sm btn-edit">Editar</a>
                                    <a href="<%= request.getContextPath() %>/ProveedorController?accion=eliminar&id=<%= p.getIdProveedor() %>"
